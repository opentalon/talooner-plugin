...
func TestReviewNilHostIsError(t *testing.T) {
	got := Review(context.Background(), nil, ReviewInput{DocURL: "d", Diff: "x"})
...
func TestReviewTruncatedDiffIsTooLarge(t *testing.T) {
	...
	got := Review(context.Background(), host, ReviewInput{DocURL: "d", Diff: "x", DiffTruncated: true})
...
func TestReviewParsesStructuredVerdict(t *testing.T) {
	...
	got := Review(context.Background(), host, ReviewInput{DocURL: "d", Diff: "x"})
